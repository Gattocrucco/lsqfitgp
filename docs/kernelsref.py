...
.. warning::
   ...
   only in more than one dimension). :class:`Matern` is not derivable for
   integer :math:`\\nu`. The following kernels are not compatible with the JAX
   JIT: :class:`Bessel`, :class:`Matern`, :class:`Pink`, :class:`Taylor`.
