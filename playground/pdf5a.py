...
Like pdf5, but actually only linear data"""
...
def gvar_einsum(*args, **kw):
    return opt_einsum.contract(*args, backend='object', **kw)
...
fit = lsqfit.nonlinear_fit(data, fcn, params_prior, p0=priorsample, verbose=2)
...
fig, axs = plt.subplots(1, 2, num='pdf5a', clear=True, figsize=[9, 4.5])
